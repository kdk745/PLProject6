...
_lr_signature = '3C75C77A49362ABD0BDFB005963FBA54'
...
_lr_productions = [
  ...
  ('exp -> atom','exp',1,'p_exp_atom','yacc.py',133),
  ('exp -> quoted_list','exp',1,'p_exp_qlist','yacc.py',137),
  ('exp -> call','exp',1,'p_exp_call','yacc.py',141),
  ('quoted_list -> QUOTE list','quoted_list',2,'p_quoted_list','yacc.py',145),
  ...
  ('atom -> bool','atom',1,'p_atom_bool','yacc.py',196),
  ('atom -> NUM','atom',1,'p_atom_num','yacc.py',200),
  ('atom -> TEXT','atom',1,'p_atom_word','yacc.py',204),
  ('atom -> <empty>','atom',0,'p_atom_empty','yacc.py',208),
  ('bool -> TRUE','bool',1,'p_true','yacc.py',212),
  ('bool -> FALSE','bool',1,'p_false','yacc.py',216),
  ('atom -> NIL','atom',1,'p_nil','yacc.py',220),
]
